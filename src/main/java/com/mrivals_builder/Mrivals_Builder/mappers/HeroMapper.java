...
import com.mrivals_builder.Mrivals_Builder.dtos.ExternalApiDTOs.HeroDTOs.AbilityExternalApiDTO;
...
public class HeroMapper {
    ...
    public static HeroDTO entityToDTO(Hero hero){
        ...
        List<MatchUpDTO> matchUps = MatchUpMapper.ListEntityToDTO(hero.getMatchUps());
